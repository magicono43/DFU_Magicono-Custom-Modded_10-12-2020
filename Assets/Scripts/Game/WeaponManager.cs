...
namespace DaggerfallWorkshop.Game
{
    ...
    public class WeaponManager : MonoBehaviour
    {
        ...
        public static int PlayerDamageTypeUsed(FPSWeapon onscreenWeapon, DaggerfallUnityItem weapon = null) // Check what damage type the player is using this attack.
        {
                    ...
                    switch (weapon.TemplateIndex)
                    {
                        ...
                        case (int)Weapons.Tanto:
                            ...
                            if (onscreenWeapon.WeaponState == WeaponStates.StrikeDown)
                                return 3;
                            if (onscreenWeapon.WeaponState == WeaponStates.StrikeLeft)
                                return 2;
